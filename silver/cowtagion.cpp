// Author: envy
// Problem: Problem 1. Cowntagion from USACO - USACO 2020 December Contest, Silver
// URL: http://www.usaco.org/index.php?page=viewproblem2&cpid=1062
// Limits: 4000 ms, 256 MB
// Attempted: 2021-09-12 07:13:38 EST
...
void dfs(int node){
	...
	while(cowshere[node] < (node == 1 ? graph[node].size()+1:graph[node].size())){
		cowshere[node] *= 2;
		days++;
	}
