// Author: envy
// Problem: Problem 3. Mountain View from USACO - USACO 2019 January Contest, Silver
// URL: http://www.usaco.org/index.php?page=viewproblem2&cpid=896
// Limits: 4000 ms, 256 MB
// Attempted: 2021-09-12 12:42:50 EST
...
void doStuff(){
	...
	// F is left bound, S is right bound
	for(int i = 0; i < n; i++){
		int a,b; ri(a,b);
		nums[i] = mp(a-b,a+b);
	}
	sort(all(nums),customsort);
