// Author: envy
// Problem: Problem 3. Swapity Swap from USACO - USACO 2020 February Contest, Bronze
// URL: http://www.usaco.org/index.php?page=viewproblem2&cpid=1013
// Limits: 4000 ms, 256 MB
// Attempted: 2021-10-10 17:59:31 EST
...
void op(vector<int>& arr){
	reverse(arr.begin()+a,arr.begin()+b+1);
	reverse(arr.begin()+c,arr.begin()+d+1);
}
