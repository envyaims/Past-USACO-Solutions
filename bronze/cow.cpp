// Problem: Problem 2. COW
// Contest: USACO - USACO 2015 February Contest, Bronze
// URL: http://www.usaco.org/index.php?page=viewproblem2&cpid=527
// Memory Limit: 256 MB
// Time Limit: 4000 ms
// Input: stdin   
// Output: stdout   
// Attempted: 2021-08-16 15:30:16 EST
...
void doStuff(){
	...
	for(int i = 1; i < n-1; i++){
		if(s[i] == 'O'){
			ans += count(s.begin(),s.begin()+i,'C') * count(s.begin()+i,s.end(),'W');
		}
	}
	print(ans);
